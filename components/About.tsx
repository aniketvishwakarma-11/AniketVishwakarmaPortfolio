            ...
            <div className="flex flex-col sm:flex-row gap-6 items-start">
              ...
              <div className="flex-1">
                ...
                <p className="text-slate-400 text-sm leading-relaxed mb-3">
                  ...
                  With 9+ deployed platforms, I specialize in combining real-time communication (WebRTC, Socket.IO) with scalable MERN architectures.
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 pt-2 border-t border-white/5">
                  <div className="text-xs text-slate-400">
                    <span className="text-cyan-400 font-semibold block text-sm">9+</span>
                    Production Apps
                  </div>
                  <div className="text-xs text-slate-400">
